...
class CoinSearchAdapter(private val itemClick: (Coin)-> Unit ): PagingDataAdapter<Coin, CoinSearchAdapter.CoinViewHolder>(CoinsDiffCallback()) {
    ...
    override fun onBindViewHolder(holder: CoinViewHolder, position: Int) {
        with(holder){
            with(getItem(position)?: return) {
                ...
                binding.coinPeriodTextView.text=year
                binding.coinEstimateTextView.text=estimate
